              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    required={!isLogin}
                    className="w-full pl-10 pr-4 py-2 border border-gray-200 rounded-xl text-gray-900 bg-white focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent transition-all"
